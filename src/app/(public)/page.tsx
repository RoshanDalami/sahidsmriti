"use client";
import CarouselComponent from "@/app/(public)/Components/Carousel";

import Link from "next/link";
import { MiddleData } from "../../../public/Data/middleData";
import HomeMid from "@/app/(public)/Components/homeComponent";
...
export default function Home() {
  return (
    <>
      ...
      <div className="flex flex-col justify-center flex-wrap items-center mt-[100px] md:mt-[600px] md:flex-row ">
        {MiddleData &&
          MiddleData.map((item) => {
            return (
