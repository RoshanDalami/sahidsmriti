...
export default function AppointmentForm() {
  ...
  return (
    <div className="flex justify-evenly bg-rose-700 px-10 py-7 text-white  flex-wrap">
      <div>
        ...
        >
          ...
          <div className="my-3">
            <input
              ...
              required
              onChange={(e) =>
                setAppointment({ ...appointment, number: e.target.value })
              }
          ...
          <button
            type="submit"
            className="px-3 py-2 bg-blue-600 rounded text-white font-medium hover:bg-sky-500"
          >
            Book Now
          </button>
        </form>
