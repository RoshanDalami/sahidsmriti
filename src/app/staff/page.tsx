...
export default function StaffPage(){
    return(
        <div className='bg-gradient-to-t from-blue-300  to-sky-600 '>
            {/* clinical */}
           <div className=''>
            <h1 className='text-center text-4xl pt-4'>Clinical Staff</h1>
            <div className='flex items-center justify-center flex-wrap'>
                {
                    Clinical.map((item:any)=>{
                        return(
                            <Card key={item.id} title={item.title} image={item.image} description={item.degnation} />
                        )
                    })
                }
           ...
           {/* Laboratory */}
           <div className='m-4'>
            <h1 className='text-center text-4xl'> Laboratory Staff </h1>
            <div className='flex items-center justify-center flex-wrap '>
            {
                    Lab.map((item:any)=>{
                        return(
           ...
           {/* Pharamacy  */}
           <div className='m-4'>
            <h1 className='text-center text-4xl'>Pharamcy Staff</h1>
            <div className='flex items-center justify-center flex-wrap'>
            {
           ...
           <div className='m-4'>
            <h1 className='text-center text-4xl'>Radiography Staff</h1>
            <div className='flex items-center justify-center flex-wrap'>
            {
